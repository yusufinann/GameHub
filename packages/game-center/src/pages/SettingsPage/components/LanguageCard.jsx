      ...
      >
        ...
        <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ width: '50%', p: 1.5 }}>
              <Paper
                ...
                sx={{
                  ...
                  borderRadius: 3,
                  cursor: 'pointer',
                  border: language === 'tr' ? `2px solid ${primary.main}` : 'none',
            ...
            <Box sx={{ width: '50%', p: 1.5 }}>
              <Paper
                ...
                sx={{
                  ...
                  borderRadius: 3,
                  cursor: 'pointer',
                  border: language === 'en' ? `2px solid ${primary.main}` : 'none',
                  transition: 'transform 0.2s ease',
                  '&:hover': {
                    transform: 'translateY(-5px)'
                  },
          ...
          <Box sx={{ 
            ...
            borderRadius: 2,
            border: `1px dashed ${alpha(text.primary, 0.1)}`,
          }}>
            <Typography variant="body2" color="text.secondary" sx={{ fontStyle: 'italic', textAlign: 'center' }}>
              {language === 'tr' 
                ? 'Tercih ettiğiniz dil tüm arayüz metinlerine uygulanacaktır.' 
                : 'Your preferred language will be applied to all interface text.'}
            </Typography>
          </Box>
        </Box>
      </Paper>
