...
if (userJoinNotifications.length > 0) {
  ...
  if (notifications.filter(notif => notif.type === 'friend-group-invite').length > 0) {
...
if (eventNotifications.length === 0 && incomingRequests.length === 0 && lobbyInviteNotifications.length === 0 && friendGroupInviteNotifications.length === 0 && userJoinNotifications.length === 0) {
  items.push(
